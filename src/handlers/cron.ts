...
/** The outcome of one run, as logged and as returned for a test to assert on. */
export type CronRunSummary = {
  /** The JST day the digests cover. */
  date: string;
  /** Subscriptions considered. */
  total: number;
  generated: number;
  /** Already in KV, or being generated by a crawl right now. */
  skipped: number;
  failed: number;
  durationMs: number;
};
 ...
 */
function logRun(trigger: CronTrigger, summary: CronRunSummary): CronRunSummary {
